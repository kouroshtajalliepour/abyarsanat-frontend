...
import ChangeableIconsEnamad from "@/components/changeableIcons/enamad.vue";
import ChangeableIconsSamandehi from "@/components/changeableIcons/samandehi.vue";

// * props & emits
const props = defineProps<{
  hideFooterInMobile?: boolean;
...
<template>
  <footer :class="['footer-wrapper', hideFooterInMobile ? 'hide-in-mobile' : '']">
    <div class="footer-upper-section">
      <div class="contact-logo-wrapper">
        ...
        >
          <ChangeableIconsLogo index="3" class="logo-wrapper" />
        </NuxtLink>
      </div>
      <div class="footer-description-wrapper">
        <p>{{ t("pages.footer.description") }}</p>
      </div>
    </div>
    <nav class="footer-mid-section">
      <ul class="navigation-wrapper">
        <li class="navigation-group">
          <p class="footer-heading">{{ t("pages.links.quickAccess") }}</p>
          <NuxtLink
            class="footer-link"
            :to="localePath('/about')"
          ...
          <NuxtLink
            class="footer-link"
            :to="localePath('/faq')"
            :aria-label="t('pages.links.faq')"
            >{{ t("pages.faq.title") }}</NuxtLink
          >
          <NuxtLink
            class="footer-link"
            :to="localePath('/terms')"
            :aria-label="t('pages.links.terms')"
            >{{ t("pages.terms.title") }}</NuxtLink
          >
        </li>
      </ul>
    </nav>
    <div class="footer-lower-section">
      <ul class="navigation-wrapper">
        <li class="navigation-group contact-navigation-group">
          <p class="footer-heading">{{ t("pages.contact.title") }}</p>
          <!-- <a
            class="footer-link footer-contact-link"
            :href="`tel:${salesNumber}`"
            :aria-label="t('pages.contact.labels.sales')"
          >
            <span>{{ t("pages.contact.labels.sales") }}</span>
          ...
          <a
            ...
            v-if="!loading"
            :aria-label="t('pages.contact.labels.support')"
          >
            <span>{{ t("pages.contact.labels.support") }}</span>
            <span>{{ supportNumber }}</span>
          </a>
          <!-- todo: add instagram logo ASAP -->
          <!-- <a
            class="footer-link footer-contact-link"
            :href="`tel:${contactNumber}`"
            :aria-label="t('pages.contact.labels.contact')"
          >
            <span>{{ t("pages.contact.labels.contact") }}</span>
      ...
      <div class="licenses">
        <button
          ...
          type="button"
          class="lead-licenses-button"
        >
          {{ t("pages.showLicenses") }}
        </button>
        <ChangeableIconsEnamad v-if="showLicenses" />
        <ChangeableIconsSamandehi v-if="showLicenses" />
      </div>
    </div>
  </footer>
</template>
